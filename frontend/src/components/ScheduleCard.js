...
<div className="col-4">
            <div className="card card-block caard"><div class="card text-center">
  <div class="card-header myfontsize" style={{fontWeight:"bold",backgroundColor:"black" ,color:"white"}}>
  {props.schedule['day']}
  ...
  <a href="#" class="btn " style={{backgroundColor:"#B8405E"}}>Reserve</a>
  </div>
</div></div>
        </div>
